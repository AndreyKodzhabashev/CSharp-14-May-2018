...
namespace Ex02_Pr04_Hotel
{
    class Ex02_Pr04_Hotel
    {
        static void Main()
        {
            ...
            if (14 < nights)
            {
                ...
                if (month.Equals("july") || month.Equals("august") || month.Equals("December", StringComparison.InvariantCultureIgnoreCase))
                {
